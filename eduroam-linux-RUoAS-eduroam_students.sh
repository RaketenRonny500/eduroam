...
Config.instname = "Rhine-Waal University of Applied Sciences"
Config.profilename = "eduroam students"
Config.url = "http://itstart.hsrw.org"
Config.email = "itsupport@hochschule-rhein-waal.de"
Config.title = "eduroam CAT"
Config.server_match = "eduroam-radius.hochschule-rhein-waal.de"
...
Config.user_realm = "students.hochschule-rhein-waal.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam-radius.hochschule-rhein-waal.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@students.hochschule-rhein-waal.de"
Config.tou = ""
